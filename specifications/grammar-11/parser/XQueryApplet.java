...
public class XPathApplet extends Applet {
    ...
    protected XQueryXConverter getXQueryXTranslator() throws UnsupportedEncodingException{
    	return new XQueryXConverter();
    }
        ...
        try {
            ...
            if (null == tree)
                ...
                ByteArrayOutputStream baos = new ByteArrayOutputStream(
                        62 * 1024);
                PrintStream ps = new PrintStream(baos);
                XQueryXConverter trans = getXQueryXTranslator();
