...
<!-- This stylesheet was a one-off exercise to extract function definitions from the prose format of the XPath 2.0/XQuery 1.0 specification
     into the more structured catalog format used in 3.0 -->	
