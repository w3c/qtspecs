...
<!-- Realign with Update 1.1 (not 1.0) 2010-05-13: Jim Melton -->

<!-- TEMPORARY CHANGE to import the underlying stylesheet from a local file instead of the web -->
<xsl:import href="file:///e:/w3ccvs/WWW/XML/Group/qtspecs/specifications/xquery-update-11/src/xquery-update-11-xqueryx.xsl"/>
<!-- TEMPORARY CHANGE to import the underlying stylesheet from a local file instead of the web
