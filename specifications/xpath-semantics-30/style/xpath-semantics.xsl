...
<!--
   <xsl:param name="xpath-doc" select="'http://www.w3.org/TR/2003/WD-xpath20-20030502/'"/>
   <xsl:param name="xquery-doc" select="'http://www.w3.org/TR/2003/WD-xquery-20030502/'"/>
-->
...
<!-- 2008-09-24: Jim agrees and deleted three templates that had been commented out -->
...
<!-- 2008-09-24: Jim deleted some code that had been commented out to clean up this stylesheet -->
               </b>
               <xsl:apply-templates/>
               <xsl:text>]</xsl:text>
            </xsl:when>
...
<!-- 2008-09-24: Jim deleted two templates that had been commented out to clean up this stylesheet -->
...
<!-- 2008-09-24: Jim deleted a template that had been commented out to clean up this stylesheet -->
   <!-- Some font switches -->
            ...
            <xsl:choose>
              ...
              <xsl:otherwise>
                ...
                <xsl:choose>
                  ...
                  <xsl:otherwise>
                    <xsl:message>
                      <xsl:text>nt target not found! nt/@def="</xsl:text>
                      <xsl:value-of select="@def"/>
                      <xsl:text>"  ~~ looked for core $def3="</xsl:text>
...
<xsl:template match="a" priority="10">
  <xsl:if test="starts-with(@href,'#') and not(key('ids', substring-after(@href,'#')))">
    <xsl:message>
      <xsl:text>ERROR: broken link: a/@href="</xsl:text>
