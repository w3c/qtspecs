...
<xsl:import href="xpath-semantics.xsl"/>
...
div.diff-del  { background-color: #FFBBBB; text-decoration: line-through; }
div.diff-chg  { background-color: #99FF99; }
div.diff-off  {  }

span.diff-add { background-color: #FFFF99; }
span.diff-del { background-color: #FFBBBB; text-decoration: line-through; }
span.diff-chg { background-color: #99FF99; }
span.diff-off {  }

td.diff-add   { background-color: #FFFF99; }
td.diff-del   { background-color: #FFBBBB; text-decoration: line-through }
