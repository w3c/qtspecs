...
<xsl:template match="/">
  <table border="0" cellspacing="0" width="80%" summary="Datamodel Example">
    <col width="150"/>
    <tbody>
...
<xsl:template match="document">
  ...
  <tr role="document">
    <td valign="baseline">dm:string-value(<xsl:value-of select="@label"/>)</td>
    <td valign="baseline">=</td>
    <td><xsl:call-template name="value"/></td>
  </tr>
  <tr role="document">
    <td valign="baseline">dm:typed-value(<xsl:value-of select="@label"/>)</td>
    <td valign="baseline">=</td>
...
<xsl:template match="element">
  ...
  <tr role="element">
    <td valign="baseline">dm:namespace-bindings(<xsl:value-of select="@label"/>)</td>
    <td valign="baseline"> =&#160;</td>
    <td>
      <xsl:text>(</xsl:text>
      <xsl:for-each select="/document/namespace">
...
<xsl:template match="processing-instruction[true()]">
  <tr role="processing-instruction" id="ex-{@label}">
    <td colspan="3">
