...
<!--
   ...
   2015-02-09: Andy modified the Copyright statement to remove 'All Rights Reserved',
   in line with pubrules

   2014-01-31: Jim revised the text for errataloc per email from Ian Jacobs 2014-01-21

   2013-03-19: JimM edited the file to change the copyright statement
   by adding Beihang (http://ev.buaa.edu.cn/) after Keio. 
   
   2012-05-31: MikeK added exclude-result-prefixes="xs" in an attempt
   to reduce the number of HTML validation errors generated.

   2010-01-25: JimM edited the file to change the URI for ERCIM,
   replacing ".org" with ".eu" per
   http://lists.w3.org/Archives/Member/chairs/2010JanMar/0009.html
...
<!-- xmlspec.xsl: An HTML XSL[1] Stylesheet for XML Spec V2.1[2] markup
     ...
     Version: $Id: xmlspec.xsl,v 1.20 2016/07/14 17:31:08 mkay Exp $
     ...
     Date:    Created 07 September 1999
              Last updated $Date: 2016/07/14 17:31:08 $ by $Author: mkay $
...
<!-- 2014-01-31: Jim revised the text for errataloc per email from Ian Jacobs 2014-01-21 -->
  ...
  <xsl:template match="caption|col|colgroup|tfoot|thead|tr|tbody">
    <xsl:element name="{local-name(.)}">
      <xsl:apply-templates select="@*" mode="table-attributes"/>
      <xsl:apply-templates/>
    </xsl:element>
  </xsl:template>
  ...
  <xsl:template match="@diff | @at | @id | @xml:id | 
